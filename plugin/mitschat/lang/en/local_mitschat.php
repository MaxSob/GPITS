...
$string['pluginname'] = 'MITS Chat';
$string['linceskey'] = 'API key';
$string['configlinceskey'] = 'Enter the API key';
$string['pagenotfound'] = 'Page not found';
$string['enablemitschat'] = 'Enable mitschat';
$string['configermitschat'] = 'Enable this option if you want to add mitschat.';
