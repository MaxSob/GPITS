        ...
        _create: function(){
            ...
            .clickToggle(function() {
                if($('#stickybar').hasClass('maximize')){
                    ...
                    $('#hide_bar input').prop('title', 'Abrir chat');
                    io.disconnect();
                    $('.ui-memblist').remove();
                    $('.ui-chatbox').remove();
                    $('div#chatrm').remove();
                    ...
                    mitsstorage = {}; //remove variable storage
            ...
            function() {
                ...
                $('#hide_bar input').prop('title', 'Cerrar chat');
                localStorage.clear();
                io.init(dataobject);
            });
